...
print("Old Pipeline:")
print("-------------")
clf_oldpl = create_old_cl()
print("F1 with 5 fold cv: ", score_cl(clf=clf_oldpl, scoring=make_scorer(f1_score), X=X_data, y=y_data).mean())
print("Balanced Accuracy with 5 fold cv: ", score_cl(clf=clf_oldpl, scoring=make_scorer(balanced_accuracy_score), X=X_data, y=y_data).mean())
print("MCC with 5 fold cv: ", score_cl(clf=clf_oldpl, scoring=make_scorer(matthews_corrcoef), X=X_data, y=y_data).mean())
